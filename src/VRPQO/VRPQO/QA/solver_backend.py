...
class SolverBackend:
    ...
    def __init__(self, vrp):
        ...
        self.solvers = {'dwave': self.solve_dwave,
                        ...
                        'sim_anneal': self.solve_simulated_anneal}
    ...
    def solve_simulated_anneal(self, **params):
    ...
    def solve_cplex(self, **params):

        """Solve using qiskit cplex optimizer.
        Args:
            params: Additional parameters that may be required by a solver. Not required here.
        """
        ...
        self.vrp.result = optimizer.solve(self.vrp.qp)
        self.vrp.timing['cplex_solution_time'] = (time.time() - self.vrp.clock) * 1e6
