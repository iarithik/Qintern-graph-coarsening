...
from classical.VRPSolution import VRPSolution
...
class VRPTW(VRPBase):
    ...
    def print_solution(self, manager, routing, solution):
        # TODO delete this method after implementing convert_solution method
